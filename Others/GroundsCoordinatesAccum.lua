...
local groundGridManager = function()
	...
	self.isGround = function(x, y)
		return map[currentMap] and map[currentMap][x] and map[currentMap][x][y] or false
	end
...
eventNewGame = function()
	...
	if xml then
		mapGrid.new(tfm.get.room.currentMap, xml.xml)
	else
		mapGrid.new(tfm.get.room.currentMap)
	end
end
